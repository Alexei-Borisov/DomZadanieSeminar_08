...
# который отвечает за основной продукт к выбираемому супу. В этом классе создать метод show_my_soup(), 
...
class Soup:
    ...
    def show_my_soup(self):
        if self.ingridient == 'свекла':
            ...
            return f'В супе "{self.soup}" главный ингридиент - "{self.ingridient}"'
        else:
